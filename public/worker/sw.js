const APP_VERSION = '6';
const CACHE_PREFIX = 'gennaro-basco-worker-';
...
const ASSETS = [
  ...
  '/worker/images/logo/logo_basco_demo_without_bg.png',
  '/worker/images/logo/logo_basco_demo.png',
  '/worker/images/logo/logo_basco_only_white.png',
];
